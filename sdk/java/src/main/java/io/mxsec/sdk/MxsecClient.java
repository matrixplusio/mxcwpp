...
/**
 * mxsec API Java SDK (P4-5).
 *
 * 用法:
 *
 *   MxsecClient cli = MxsecClient.builder()
 *       .baseUrl("https://mxsec.example.com")
 *       .token("eyJhbGc...")
 *       .build();
...
public class MxsecClient {
    ...
    private String doRequest(String method, String url, String body)
        ...
        if (resp.statusCode() >= 400) {
            throw new IOException("mxsec " + method + " " + resp.statusCode()
                + ": " + resp.body());
        }
        return resp.body();
    }
    ...
    public static class Builder {
        ...
        private String userAgent = "mxsec-java-sdk/0.1.0";
