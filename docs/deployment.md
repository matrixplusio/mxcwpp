...
make dev-docker-restart  # 重启 manager + ui
```
...
release:
  version: v1.0.0
  install_dir: /opt/mxsec-platform
  data_root: /data/mxsec
...
# 构建并推送到私有仓库
./scripts/build-images.sh --version v1.0.0 --registry registry.example.com/mxsec --push
```
