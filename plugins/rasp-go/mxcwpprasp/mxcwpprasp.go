...
// 使用方式 (业务代码侧):
//
//	import "github.com/matrixplusio/mxcwpp/plugins/rasp-go/mxcwpprasp"
//
//	func main() {
//	    mxcwpprasp.Install(mxcwpprasp.Config{
//	        UDSPath: "/var/run/mxcwpp/rasp-go.sock",
//	        TenantID: "t-default",
//	    })
//	    defer mxcwpprasp.Shutdown()
//	    // ... 业务代码 ...
//	}
//
// 然后在敏感调用点上报:
...
//	mxcwpprasp.ObserveCmdExec(cmd.Path, cmd.Args)
//	cmd.Run()
//
