...
/**
 * mxsec Java RASP Agent premain 入口 (P4-1).
 *
 * 启用:
 *   java -javaagent:/opt/mxsec/rasp/libmxsec_rasp.jar \
...
public class MxsecAgent {
    ...
    public static void premain(String agentArgs, Instrumentation inst) {
        try {
            ...
            // 永不抛, 业务零影响
            System.err.println("[mxsec-rasp] premain init failed: " + t.getMessage());
        }
    }
    ...
    public static void agentmain(String agentArgs, Instrumentation inst) {
        try {
            ...
            System.err.println("[mxsec-rasp] agentmain init failed: " + t.getMessage());
        }
    }
    ...
    private static void startup(String agentArgs, Instrumentation inst, boolean isAttach) {
        ...
        System.out.println("[mxsec-rasp] agent started"
